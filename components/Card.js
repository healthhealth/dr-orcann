      ...
      {isExpanded && (
        <div
          className={`mt-6 pt-4 border-t ${
            isExpanded ? 'border-white' : 'border-gray-700'
          } transition-colors duration-500`}
        >
          <div
            className={`mt-4 pt-4 border-t ${
              isExpanded ? 'border-gray-200' : 'border-gray-700'
            }`}
          >
            {details}
              ...
              <li>
                <Link
                  ...
                  className={`hover:underline ${
                    isExpanded ? 'text-blue-300' : 'text-blue-600'
                  }`}
                >
                  Artigo sobre {title}
                </Link>
            ...
            <div className="space-y-2">
              <details className="border border-gray-200 rounded p-2">
                ...
                <p
                  className={`mt-2 ${
                    isExpanded ? 'text-gray-100' : 'text-gray-600'
                  }`}
                >
